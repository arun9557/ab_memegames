    ...
    return (
        <footer className="custom-footer">
            <div className="footer-nav">
                ...
                <a href="https://meme-games.vercel.app/trending" className="footer-link">Games</a>
            ...
            <div className="footer-socials">
                {/* GitHub */}
                <a href="https://github.com/Meme-Games-Org" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="GitHub">
